alias cdas='cd ${GRADLE_WORKSPACE}/au-timemanagement/au-timemanagement-sapui5-web'
alias cdap='cd ${GRADLE_WORKSPACE}/au-timemanagement/au-timemanagement-sap.sf.timemanagement.payoutAndPurchase-web/'
alias cda='cd ${GRADLE_WORKSPACE}/au-timemanagement'
alias cdac='cd $(find $GRADLE_WORKSPACE/au-timemanagement -maxdepth 1 ! -iname ".*" -type d -name "*sap*" | sort | fzf --header="Change to au-timemanagement subdirectory")'
